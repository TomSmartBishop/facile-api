...
public class BgeS extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x2f;
	public static final byte BYTE_SIZE = 0x02;
	
	@Override
	public String render(LanguageRenderer renderer) {
		assert(renderer instanceof ILAsmRenderer);
		return "bge.s " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
