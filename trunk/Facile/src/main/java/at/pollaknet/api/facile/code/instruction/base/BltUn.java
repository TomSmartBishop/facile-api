...
public class BltUn extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x44;
	...
	public String render(LanguageRenderer renderer) {
		...
		return "blt.un " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
