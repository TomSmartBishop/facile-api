...
public class Callvirt extends ReferenceCilInstruction {

	public static final byte FIRST_TOKEN = 0x6f;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		return "callvirt " + reference.renderAsReference(renderer);
	}
