...
public class BrtrueS extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x2d;
	public static final byte BYTE_SIZE = 0x02;
	
	@Override
	public String render(LanguageRenderer renderer) {
		assert(renderer instanceof ILAsmRenderer);
		return "brtrue.s " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		return ((BrtrueS) obj).target == target;
	}
