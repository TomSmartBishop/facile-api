...
public class Ldsflda extends ReferenceCilInstruction {

	public static final byte FIRST_TOKEN = 0x7f;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		return "ldsflda " + reference.renderAsReference(renderer);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		return ((Ldsflda) obj).token == token;
	}
