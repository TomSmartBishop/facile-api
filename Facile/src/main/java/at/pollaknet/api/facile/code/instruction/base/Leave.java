...
public class Leave extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = (byte) 0xdd;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		assert(renderer instanceof ILAsmRenderer);
		return "leave " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
