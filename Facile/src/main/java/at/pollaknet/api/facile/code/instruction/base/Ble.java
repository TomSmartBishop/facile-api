...
public class Ble extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x3e;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		assert(renderer instanceof ILAsmRenderer);
		return "ble " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
