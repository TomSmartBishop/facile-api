...
public class Brfalse extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x39;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		assert(renderer instanceof ILAsmRenderer);
		return "brfalse " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
