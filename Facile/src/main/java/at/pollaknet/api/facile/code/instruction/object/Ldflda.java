...
public class Ldflda extends ReferenceCilInstruction {

	public static final byte FIRST_TOKEN = 0x7c;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		return "ldflda " + reference.renderAsReference(renderer);
	}
