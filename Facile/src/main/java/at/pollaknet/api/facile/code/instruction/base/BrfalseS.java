...
public class BrfalseS extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x2c;
	...
	public String render(LanguageRenderer renderer) {
		...
		return "brfalse.s " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		return ((BrfalseS) obj).target == target;
	}
