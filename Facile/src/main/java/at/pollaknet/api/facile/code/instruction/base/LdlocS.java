...
public class LdlocS extends CilInstruction {

	public static final byte FIRST_TOKEN = 0x11;
	...
	public short getLocalVarIndex() {
		return index;
	}
	
	public String toString() {
		return "ldloc.s " + index;
	}
