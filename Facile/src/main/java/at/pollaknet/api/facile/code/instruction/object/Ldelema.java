...
public class Ldelema extends ReferenceCilInstruction {

	public static final byte FIRST_TOKEN = (byte) 0x8f;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		return "ldelema " + reference.renderAsReference(renderer);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		return ((Ldelema) obj).token == token;
	}
