...
public abstract class AbstractGenericInstanceContainer extends AbstractMethodRefSignature {
	...
	public TypeSpec[] getGenericInstances() {
		...
		return typeSpecInstances.toArray(new TypeSpec[typeSpecInstances.size()]);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AbstractGenericInstanceContainer other = (AbstractGenericInstanceContainer) obj;
