...
public class Bge extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x3c;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		assert(renderer instanceof ILAsmRenderer);
		return "bge " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
