...
public class BgeUn extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x41;
	...
	public String render(LanguageRenderer renderer) {
		...
		return "bge.un " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		return ((BgeUn) obj).target == target;
	}
