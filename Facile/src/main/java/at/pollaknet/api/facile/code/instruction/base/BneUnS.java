...
public class BneUnS extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x33;
	...
	public String render(LanguageRenderer renderer) {
		...
		return "bne.un.s " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		return ((BneUnS) obj).target == target;
	}
