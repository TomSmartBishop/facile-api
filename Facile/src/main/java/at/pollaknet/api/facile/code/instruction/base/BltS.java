...
public class BltS extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x32;
	...
	public String render(LanguageRenderer renderer) {
		...
		return "blt.s " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
