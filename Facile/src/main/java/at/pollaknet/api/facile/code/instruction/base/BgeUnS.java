...
public class BgeUnS extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x34;
	public static final byte BYTE_SIZE = 0x02;
	
	@Override
	public String render(LanguageRenderer renderer) {
		assert(renderer instanceof ILAsmRenderer);
		return "bge.un.s " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		return ((BgeUnS) obj).target == target;
	}
