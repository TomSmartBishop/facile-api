...
public class BgtS extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x30;
	...
	public String render(LanguageRenderer renderer) {
		...
		return "bgt.s " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
