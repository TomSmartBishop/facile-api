...
public class Stfld extends ReferenceCilInstruction {

	public static final byte FIRST_TOKEN = 0x7d;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		return "stfld " + reference.renderAsReference(renderer);
	}
