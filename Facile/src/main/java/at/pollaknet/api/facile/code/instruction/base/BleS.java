...
public class BleS extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x31;
	public static final byte BYTE_SIZE = 0x02;

	@Override
	public String render(LanguageRenderer renderer) {
		assert(renderer instanceof ILAsmRenderer);
		return "ble.s " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
