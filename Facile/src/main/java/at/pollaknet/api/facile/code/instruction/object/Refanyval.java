...
public class Refanyval extends ReferenceCilInstruction {

	public static final byte FIRST_TOKEN = (byte) 0xc2;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		return "refanyval " + reference.renderAsReference(renderer);
	}
