...
public class UnboxAny extends ReferenceCilInstruction {

	public static final byte FIRST_TOKEN = (byte) 0xa5;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		return "unbox.any " + reference.renderAsReference(renderer);
	}
