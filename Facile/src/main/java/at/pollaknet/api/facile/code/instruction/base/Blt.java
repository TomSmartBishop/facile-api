...
public class Blt extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x3f;
	...
	public String render(LanguageRenderer renderer) {
		...
		return "blt " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
