...
public class Ldsfld extends ReferenceCilInstruction {

	public static final byte FIRST_TOKEN = 0x7e;
	public static final byte BYTE_SIZE = 0x05;
	
	@Override
	public String render(LanguageRenderer renderer) {
		return "ldsfld " + reference.renderAsReference(renderer);
	}
