...
public class BleUn extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x43;
	...
	public String render(LanguageRenderer renderer) {
		...
		return "ble.un " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		return ((BleUn) obj).target == target;
	}
