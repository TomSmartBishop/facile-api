...
public class BgtUn extends TargetCilInstruction {

	public static final byte FIRST_TOKEN = 0x42;
	...
	public String render(LanguageRenderer renderer) {
		...
		return "bgt.un " + ((ILAsmRenderer)renderer).renderRelativeAsLabel(target);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		return ((BgtUn) obj).target == target;
	}
